    ...
    return (
        <div className="flex gap-6 my-20 px-20">
            ...
            <div className="w-3/5">
                ...
                <p className='all-font text-justify opacity-70 pt-4 pb-10'>GlamHub is your premier destination for mastering the art of makeup. Our platform offers a comprehensive learning experience, from fundamental techniques to advanced skills. Whether you are a makeup enthusiast or aspiring artist, GlamHub provides expert tutorials, fostering a vibrant community where you can share, connect, and elevate your beauty journey. <h4 className='mt-2'><br /> Join us to explore and teach a spectrum of makeup styles, enhancing your skills and unleashing your creative potential. Welcome to the ultimate makeup education hub, where glamour meets expertise!</h4></p>
