    ...
    return (
        <div style={{ height: '80vh', width: '100%' }} className="bg-black mb-20 relative">
            ...
            <>
                ...
                >
                    <SwiperSlide>
                        <h2 className='text-center heading-font text-3xl tracking-wider text-[#DD6E8B]'>HAPPY STUDENT !</h2>
                        ...
                        <img className='h-14 w-14 rounded-full mx-auto object-cover' src="https://i.ibb.co/LnvPyFw/pexels-photo-1999532.jpg" alt="" />
                    ...
                    <SwiperSlide>
                        ...
                        <img className='h-14 w-14 rounded-full mx-auto object-cover' src="https://i.ibb.co/qM1p58y/pexels-photo-3660033.jpg" alt="" />
                    ...
                    <SwiperSlide>
                        ...
                        <img className='h-14 w-14 rounded-full mx-auto object-cover' src="https://i.ibb.co/0tBDSP7/pexels-photo-2689682.jpg" alt="" />
