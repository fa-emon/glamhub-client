...
const Register = () => {
    ...
    return (
        <div className="hero min-h-screen bgImage bg-slate-100">
                    ...
                    <div className="card w-full shadow-2xl bg-base-100">
                        <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                            ...
                            <div className="flex w-full">
                                {/* {email field} */}
                                <div className="form-control all-font w-1/2 me-4">
                                    <label className="label">
                            ...
                            <div className="flex me-4 all-font w-full">
                                {/* {password field} */}
                            ...
                            <div className="form-control mt-6">
                                <input className="btn bg-[#DD6E8B] hover:bg-black text-white" type="submit" value="Sign Up" />
                            </div>
                            <p className='text-[#DD6E8B] font-medium text-xl text-center all-font'><small>Already have an account? <Link to={'/login'}>LOG IN</Link></small></p>
